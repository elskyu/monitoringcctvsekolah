function filterSidebar() {
    const input = document.getElementById('searchPanoramaSidebar');
    const filter = input.value.toLowerCase();

    // Ambil semua container wilayah (.menu > .item)
    ...
    wilayahItems.forEach(wilayahItem => {
        ...
        labels.forEach(label => {
            const namaTitik = label.querySelector('span.form-check-label').textContent.toLowerCase();
        ...
        function updateStatistics() {
            ...
            const regionCount = document.getElementById('regionCountData').getAttribute('data-region-count');
