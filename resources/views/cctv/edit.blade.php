                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('namaWilayah')border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="{{ old('region_name', $cctv->namaWilayah) }}" type="text" placeholder="Nama Wilayah" id="namaWilayah" name="namaWilayah">
                                        @error('namaWilayah')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('namaTitik')border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="{{ old('namaTitik', $cctv->namaTitik) }}" type="text" placeholder="Nama Titik" id="namaTitik" name="namaTitik">
                                        @error('namaTitik')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('link')border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="{{ old('cctv_link', $cctv->link) }}" type="text" placeholder="Link" id="link" name="link">
                                        @error('link')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
