...
<div class="container">
    ...
    <form action="{{ route('cctv.store') }}" method="POST" style="max-width: 600px; margin: 0; padding: 20px; border: 1px solid #ccc; border-radius: 5px;">
        @csrf
        <div class="form-group">
    <label for="namaWilayah">Nama Wilayah:</label>
    <input type="text" class="form-control" id="namaWilayah" name="namaWilayah" required style="width: 100%;">
</div>
<div class="form-group">
